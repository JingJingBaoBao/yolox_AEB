...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : '/home/sunxusheng/projects/yolox/yolox-pytorch-main/logs/2022_08_29/ep004-lossnan-val_loss5.046.pth',
    ...
    def detect_image(self, ori, image, file_save_path, file, crop = False, count = False):
        ...
        #   图像绘制
        #---------------------------------------------------------#
        image = cv2.cvtColor(np.array(ori), cv2.COLOR_BGR2RGB)
